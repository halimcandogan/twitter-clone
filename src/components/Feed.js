...
import { ReplyIcon,LikeIcon, ReTweetIcon,ShareIcon } from '../icons/Icons'

{/*Api veya veritabanından gelen veriler burada render edilecek */}

const Feed = ({ name, username, profileimage, time,content, image}) => {
  return (
    <article className="flex space-x-3 border-b border-gray-extraLight px-4 py-3 cursor-pointer">
    <img src={profileimage} className="w-11 h-11 rounded-full" />
    <div className="flex-1">
      ...
      <ul className="-ml-1 mt-3 flex justify-between max-w-md">
        <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
          ...
          <span className="group-hover:text-primary-base">18</span>
        </li>
        <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
        ...
        <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
          ...
          <span className="group-hover:text-pink-400">89</span>
        </li>
        <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
          <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-primary-light ">
